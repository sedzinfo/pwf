...
def report_efa(df,output_file,n_factors=3,rotation='promax',method='minres',
    ...
    excel_matrix(df=eigencu,writer=writer,sheetname="Eigen Communality Uniqueness",comments=comments_s1)
    excel_matrix(df=df_loadings,writer=writer,sheetname="Loadings",comments=None)
    excel_matrix(df=correlations,writer=writer,sheetname="Correlation",comments=None)
    excel_matrix(df=correlations_reproduced,writer=writer,sheetname="Correlation Reproduced",comments=None)
    excel_matrix(df=correlations_residual,writer=writer,sheetname="Correlation Residual",comments=None)
    excel_matrix(df=df_factor_variance,writer=writer,sheetname="Factor Variance",comments=None)
    excel_generic_format(df=residual_statistics,writer=writer,sheetname="Residual Statistics",comments=None)
